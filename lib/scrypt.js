...
//var PBKDF = require("./pbkdf2"); [Delete]
...
function scrypt(passwd, salt, N, r, p, dkLen) {
    ...
    B = hexToBytes(B.toString());

    for(i = 0; i < p; i++) {
        smix(B, i * 128 * r, r, N, V, XY);
    }

    var buf = bytesToHex(B);
    B = CryptoJS.enc.Hex.parse(buf);
    DK = CryptoJS.PBKDF2(passwd, B, {iterations: 1, keySize: dkLen, hasher: CryptoJS.algo.SHA256});
